...
const Modal = ({children, isOpen, onClose, title}) => {
  ...
  return (
    <div className="fixed top-10 right-0 left-0 z-50 flex items-center justify-center w-full h-[calc(100%-1rem)] max-h-full overflow-y-auto overflow-x-hidden bg-black/30 bg-opacity-50">
